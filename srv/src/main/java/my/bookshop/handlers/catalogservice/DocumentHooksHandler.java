package  my.bookshop.handlers.catalogservice;
...
/***
 * Handler class for persisted entity "Document" of service "CatalogService".
 ...
 */
public class DocumentHooksHandler {
private static final Logger LOG = LoggerFactory.getLogger (DocumentHooksHandler.class.getName());
//	@BeforeRead(entity = "Document", serviceName = "CatalogService")
//	public BeforeReadResponse beforeReadDocument(ReadRequest req, ExtensionHelper helper) {
...
//	@AfterRead(entity = "Document", serviceName = "CatalogService")
//	public ReadResponse afterReadDocument(ReadRequest req, ReadResponseAccessor res, ExtensionHelper helper) {
...
//	@BeforeQuery(entity = "Document", serviceName = "CatalogService")
//	public BeforeQueryResponse beforeQueryDocument(QueryRequest req, ExtensionHelper helper) {
//		//TODO: add your custom logic / validations here...
//
...
//	@AfterQuery(entity = "Document", serviceName = "CatalogService")
//	public QueryResponse afterQueryDocument(QueryRequest req, QueryResponseAccessor res, ExtensionHelper helper) {
...
//	}
	...
	@BeforeCreate(entity = "Document", serviceName = "CatalogService")
	public BeforeCreateResponse beforeCreateDocument(CreateRequest req, ExtensionHelper helper) {
		//EntityData data = req.getData();
//		//TODO: add your custom logic / validations here...
		LOG.error("DocumentCreateCustom");	
...
//	@AfterCreate(entity = "Document", serviceName = "CatalogService")
//	public CreateResponse afterCreateDocument(CreateRequest req, CreateResponseAccessor res, ExtensionHelper helper) {
//		//TODO: add your custom logic / validations here...
//
...
//	@BeforeUpdate(entity = "Document", serviceName = "CatalogService")
//	public BeforeUpdateResponse beforeUpdateDocument(UpdateRequest req, ExtensionHelper helper) {
//		EntityData data = req.getData();
//		//TODO: add your custom logic / validations here...
//
...
//	@AfterUpdate(entity = "Document", serviceName = "CatalogService")
//	public UpdateResponse afterUpdateDocument(UpdateRequest req, UpdateResponseAccessor res, ExtensionHelper helper) {
//		//TODO: add your custom logic / validations here...
//
//		return res.getOriginalResponse(); //use this API if operation succeeded and payload has not been modified.
...
//	@BeforeDelete(entity = "Document", serviceName = "CatalogService")
//	public BeforeDeleteResponse beforeDeleteDocument(DeleteRequest req, ExtensionHelper helper) {
//		//TODO: add your custom logic / validations here...
//
...
//	@AfterDelete(entity = "Document", serviceName = "CatalogService")
//	public DeleteResponse afterDeleteDocument(DeleteRequest req, DeleteResponseAccessor res, ExtensionHelper helper) {
//		//TODO: add your custom logic / validations here...
//
//		return res.getOriginalResponse(); //use this API if operation succeeded and payload has not been modified.
